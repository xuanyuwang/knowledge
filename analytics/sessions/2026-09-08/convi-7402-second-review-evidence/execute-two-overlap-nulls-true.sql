...
INSERT INTO scorecard_d (scorecard_id,conversation_id,scorecard_last_update_time) VALUES ('s-X-X','X-X','2021-01-01');
INSERT INTO score_d (scorecard_id,conversation_id,scorecard_last_update_time,percentage_value) VALUES ('s-X-X','X-X','2021-01-01',80);
INSERT INTO moment_annotation_mv_by_metadata_d (conversation_id,moment_template_id,metadata_string_value,update_time) VALUES ('X-X','A','X','2021-01-01');
INSERT INTO moment_annotation_mv_by_metadata_d (conversation_id,moment_template_id,metadata_string_value,update_time) VALUES ('X-X','B','X','2021-01-01');
INSERT INTO scorecard_d (scorecard_id,conversation_id,scorecard_last_update_time) VALUES ('s-X-Y','X-Y','2021-01-01');
INSERT INTO score_d (scorecard_id,conversation_id,scorecard_last_update_time,percentage_value) VALUES ('s-X-Y','X-Y','2021-01-01',80);
INSERT INTO moment_annotation_mv_by_metadata_d (conversation_id,moment_template_id,metadata_string_value,update_time) VALUES ('X-Y','A','X','2021-01-01');
INSERT INTO moment_annotation_mv_by_metadata_d (conversation_id,moment_template_id,metadata_string_value,update_time) VALUES ('X-Y','B','Y','2021-01-01');
INSERT INTO scorecard_d (scorecard_id,conversation_id,scorecard_last_update_time) VALUES ('s-X-absent','X-absent','2021-01-01');
INSERT INTO score_d (scorecard_id,conversation_id,scorecard_last_update_time,percentage_value) VALUES ('s-X-absent','X-absent','2021-01-01',80);
INSERT INTO moment_annotation_mv_by_metadata_d (conversation_id,moment_template_id,metadata_string_value,update_time) VALUES ('X-absent','A','X','2021-01-01');
INSERT INTO scorecard_d (scorecard_id,conversation_id,scorecard_last_update_time) VALUES ('s-Y-X','Y-X','2021-01-01');
INSERT INTO score_d (scorecard_id,conversation_id,scorecard_last_update_time,percentage_value) VALUES ('s-Y-X','Y-X','2021-01-01',80);
INSERT INTO moment_annotation_mv_by_metadata_d (conversation_id,moment_template_id,metadata_string_value,update_time) VALUES ('Y-X','A','Y','2021-01-01');
INSERT INTO moment_annotation_mv_by_metadata_d (conversation_id,moment_template_id,metadata_string_value,update_time) VALUES ('Y-X','B','X','2021-01-01');
INSERT INTO scorecard_d (scorecard_id,conversation_id,scorecard_last_update_time) VALUES ('s-Y-Y','Y-Y','2021-01-01');
INSERT INTO score_d (scorecard_id,conversation_id,scorecard_last_update_time,percentage_value) VALUES ('s-Y-Y','Y-Y','2021-01-01',80);
INSERT INTO moment_annotation_mv_by_metadata_d (conversation_id,moment_template_id,metadata_string_value,update_time) VALUES ('Y-Y','A','Y','2021-01-01');
INSERT INTO moment_annotation_mv_by_metadata_d (conversation_id,moment_template_id,metadata_string_value,update_time) VALUES ('Y-Y','B','Y','2021-01-01');
INSERT INTO scorecard_d (scorecard_id,conversation_id,scorecard_last_update_time) VALUES ('s-Y-absent','Y-absent','2021-01-01');
INSERT INTO score_d (scorecard_id,conversation_id,scorecard_last_update_time,percentage_value) VALUES ('s-Y-absent','Y-absent','2021-01-01',80);
INSERT INTO moment_annotation_mv_by_metadata_d (conversation_id,moment_template_id,metadata_string_value,update_time) VALUES ('Y-absent','A','Y','2021-01-01');
INSERT INTO scorecard_d (scorecard_id,conversation_id,scorecard_last_update_time) VALUES ('s-absent-X','absent-X','2021-01-01');
INSERT INTO score_d (scorecard_id,conversation_id,scorecard_last_update_time,percentage_value) VALUES ('s-absent-X','absent-X','2021-01-01',80);
INSERT INTO moment_annotation_mv_by_metadata_d (conversation_id,moment_template_id,metadata_string_value,update_time) VALUES ('absent-X','B','X','2021-01-01');
INSERT INTO scorecard_d (scorecard_id,conversation_id,scorecard_last_update_time) VALUES ('s-absent-Y','absent-Y','2021-01-01');
INSERT INTO score_d (scorecard_id,conversation_id,scorecard_last_update_time,percentage_value) VALUES ('s-absent-Y','absent-Y','2021-01-01',80);
INSERT INTO moment_annotation_mv_by_metadata_d (conversation_id,moment_template_id,metadata_string_value,update_time) VALUES ('absent-Y','B','Y','2021-01-01');
INSERT INTO scorecard_d (scorecard_id,conversation_id,scorecard_last_update_time) VALUES ('s-absent-absent','absent-absent','2021-01-01');
INSERT INTO score_d (scorecard_id,conversation_id,scorecard_last_update_time,percentage_value) VALUES ('s-absent-absent','absent-absent','2021-01-01',80);
		...
		t2_moment_annotation_filter_1 AS (
			...
			FROM
				moment_annotation_mv_by_metadata_d
			WHERE
				((moment_template_id = 'B') AND (metadata_string_value = 'X'))
		),
		...
		moment_annotation_exclude_filter_1 AS (
			...
			scorecard_score AS (
				...
				FROM
					score_d
				WHERE
					((percentage_value >= 0) AND (not_applicable <> true))
			)
