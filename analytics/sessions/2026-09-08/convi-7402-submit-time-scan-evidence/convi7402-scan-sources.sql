...
SELECT 't1_moment_annotation_filter_0', countIf(conversation_id IN ('outside','no-score')) FROM t1_moment_annotation_filter_0 UNION ALL SELECT 't2_moment_annotation_filter_0', countIf(conversation_id IN ('outside','no-score')) FROM t2_moment_annotation_filter_0 UNION ALL SELECT 't1_moment_annotation_filter_1', countIf(conversation_id IN ('outside','no-score')) FROM t1_moment_annotation_filter_1 UNION ALL SELECT 't2_moment_annotation_filter_1', countIf(conversation_id IN ('outside','no-score')) FROM t2_moment_annotation_filter_1 UNION ALL SELECT 'moment_annotation_exclude_filter_0', countIf(conversation_id_exclude_0 IN ('outside','no-score')) FROM moment_annotation_exclude_filter_0 UNION ALL SELECT 'moment_annotation_exclude_filter_1', countIf(conversation_id_exclude_1 IN ('outside','no-score')) FROM moment_annotation_exclude_filter_1