# From Scorecard APIs to Business Workflows

**Created:** 2026-06-15
**Status:** Published to `blog/2026-06-15-from-scorecard-apis-to-business-workflows.md`
...
- Generic artifact APIs work when one workflow dominates the product.
- When multiple workflows emerge, artifact names can hide business meaning.
- Type-specific scorecards can improve code organization, but they do not fully model workflow semantics.
- Shared artifact primitives should stay small and policy-light.
- Workflow-specific commands are often the right semantic layer above shared helpers.
- AI can help clean up code inside a frame, but engineers still need business context to notice when the frame is wrong.
