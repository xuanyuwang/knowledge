...
INSERT INTO moment_annotation_mv_by_metadata_d VALUES ('old-other','2020-12-28','A','Y',0,false,'2021-01-05'),('old-selected','2020-12-28','A','X',0,false,'2021-01-05');
INSERT INTO scorecard_d (scorecard_id,conversation_id,scorecard_last_update_time,scorecard_time,scorecard_submit_time) VALUES ('s-old-other','old-other','2021-01-05','2020-12-28','2021-01-05');
INSERT INTO score_d (scorecard_id,conversation_id,scorecard_last_update_time,scorecard_time,scorecard_submit_time,conversation_start_time,percentage_value,float_weight) VALUES ('s-old-other','old-other','2021-01-05','2020-12-28','2021-01-05','2020-12-28',80,1);
INSERT INTO scorecard_d (scorecard_id,conversation_id,scorecard_last_update_time,scorecard_time,scorecard_submit_time) VALUES ('s-old-selected','old-selected','2021-01-05','2020-12-28','2021-01-05');
INSERT INTO score_d (scorecard_id,conversation_id,scorecard_last_update_time,scorecard_time,scorecard_submit_time,conversation_start_time,percentage_value,float_weight) VALUES ('s-old-selected','old-selected','2021-01-05','2020-12-28','2021-01-05','2020-12-28',80,1);
...
INSERT INTO score_d (scorecard_id,conversation_id,scorecard_last_update_time,scorecard_time,scorecard_submit_time,conversation_start_time,percentage_value,float_weight) VALUES ('s-missing','missing','2021-01-05','2020-12-28','2021-01-05','2020-12-28',80,1);
		...
		t1_moment_annotation_filter_0 AS (
			...
			WHERE
				((conversation_start_time >= '2021-01-01 00:00:00') AND (conversation_start_time < '2021-01-31 00:00:00') AND (moment_template_id = 'A'))
		...
		t2_moment_annotation_filter_0 AS (
			...
			FROM
				moment_annotation_mv_by_metadata_d
			WHERE
				((conversation_start_time >= '2021-01-01 00:00:00') AND (conversation_start_time < '2021-01-31 00:00:00') AND (moment_template_id = 'A') AND (metadata_string_value = 'X'))
		),
